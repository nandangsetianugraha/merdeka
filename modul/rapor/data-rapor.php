...
while ($row = $query->fetch_assoc()) {
	...
	$aksi='
	<button type="button" class="btn btn-success mb-2" '.$status.'><i class="fa fa-print opacity-50 me-1" data-kelas="'.$kelas.'" data-id="'.$idp.'" data-tapel="'.$tapel.'" data-smt="'.$smt.'"></i> Cetak</button>
	';
